...
<hr>
		...
		<div class="row">
			<div class="col-sm-2">
				<img alt="최승교 프로필 사진" src="https://aisw.kangwon.ac.kr/app/common/attach/image/thumb_271_1632460223000.do"  onerror="this.src='../../_res/knu/_share/img/board/img-faculty-default.gif'"/>
			</div>
			<div class="col-sm-10">
				<div>
					<ul>
...
<hr>		
		...
		<div>
			...
			<div>
				...
				<br>
				<iframe title="업적" onload="iframeLoaded()" class="iframe-full-height" id="reportFrame" src="professor96ac.html?mode=report&amp;key=$cms$IwBlE4g&amp;reportType=thesis&amp;siteId=" scrolling="no" width="100%;"  frameBorder="0" style="margin: 0 auto;max-width: 1240px; display: block;"></iframe>
