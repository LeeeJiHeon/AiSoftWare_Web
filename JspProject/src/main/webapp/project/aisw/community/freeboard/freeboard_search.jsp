 ...
 try {
  ...
  if (!(rs.next()))  {
   ...
   for(int j=startrow;j<=endrow;j++) {
    ...
    String clink = "<A href=freeboard_read.jsp?table=" + table + "&id=" + keyid.elementAt(j) ;
...
/* 	out.println("<td>");
    ...
    clink = "<div class=\"container_div\"><A href=freeboard_read.jsp?table=" + table + "&id=" + keyid.elementAt(j) ;
    clink = clink + "&page=" + where + ">" + subject.elementAt(j) + "</A>";
 ...
 if (wheregroup > 1) {
  out.print("[<A href=freeboard_search.jsp?table=" + table + "&gogroup=1"); 
  out.print("&stype="+ what+"&sval=" + val +">처음</A>]");
  out.print("[<A href=freeboard_search.jsp?table=" + table + "&gogroup="+priorgroup);
 ...
 if (name.size() !=0) {
  for(int jj=startpage; jj<=endpage; jj++) {
   ...
   out.print("[<A href=freeboard_search.jsp?table=" + table + "&go="+jj);
   out.print("&stype="+ what+"&sval=" + val +">" + jj + "</A>]") ;
   }
  }
 }
 if (wheregroup < totalgroup) {
  out.print("[<A href=freeboard_search.jsp?table=" + table + "&gogroup="+ nextgroup);
  out.print("&stype="+ what+"&sval=" + val +">다음</A>]");
  out.print("[<A href=freeboard_search.jsp?table=" + table + "&gogroup="+totalgroup); 
